                ...
                locations.isEmpty() -> {
                    Box(
                        ...
                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                            Text("Nu există locații salvate", style = MaterialTheme.typography.bodyLarge)
 ...
 * MODIFICĂRI:
 * - Delete button funcțional
 * - Select button cu text în loc de icon
 * - Ordinea: [Delete] [Select]
 */
@Composable
    ...
    Card(
        ...
        Column(Modifier.fillMaxWidth()) {
            ...
            Row(
                ...
                // Delete Button (IconButton cu roșu)
                IconButton(
                    onClick = {
                    ...
                    Icon(imageVector = Icons. Filled.Delete, contentDescription = "Șterge locația")
                }

                // Select Button (TextButton cu text)
                TextButton(
                    onClick = {
